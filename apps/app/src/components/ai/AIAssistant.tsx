...
export const AIAssistant: React.FC<AIAssistantProps> = ({
  ...
  return (
    ...
    >
      {/* Chat Window */}
      <div className="animate-in fade-in slide-in-from-bottom-4 mb-0 flex h-[450px] w-[340px] flex-col overflow-hidden rounded-2xl border border-white/20 bg-slate-900/90 shadow-2xl backdrop-blur-xl duration-300 sm:w-[400px]">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-white/10 bg-white/5 p-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-white/50">Powered by Vertex AI</p>
            </div>
          </div>
